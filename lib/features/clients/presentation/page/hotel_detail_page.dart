...
class _HotelDetailPageState extends State<HotelDetailPage> {
          ...
          CustomContainer(
            child: Column(
              ...
              children: [
                ...
                _buildSearchBar(),
                const SizedBox(height: 20),
                Row(children: [Expanded(child: _buildTaskTableDesktop(state))]),
              ],
            ),
          ),
          const SizedBox(height: 20),
          ...
          Wrap(
            ...
            children: [
              ...
              _buildMobileInfoChip(
                task.fromMasterHotel ?? false ? "Import" : "Create",
                icon: task.fromMasterHotel ?? false
  ...
  Widget _buildMobileInfoChip(String label, {required IconData icon}) {
    return Container(
