...
class SubscriptionAssignmentDialog extends StatefulWidget {
  final HotelModel hotel;
  final String clientName;
  final String clientEmail;
  final Function(String purchaseId) onAssignmentComplete;

  const SubscriptionAssignmentDialog({
    super.key,
    required this.hotel,
  ...
  @override
  State<SubscriptionAssignmentDialog> createState() =>
      _SubscriptionAssignmentDialogState();
}

class _SubscriptionAssignmentDialogState
    extends State<SubscriptionAssignmentDialog> {
...
//             _buildHotelInfo(),
//             const SizedBox(height: 20),
//             _buildSubscriptionPlanSelector(),
...
//   Widget _buildSubscriptionPlanSelector() {
//     return BlocBuilder<SubscriptionCubit, SubscriptionState>(
//       builder: (context, state) {
//         if (state.isLoading) {
...
//                     ? Text(
//                         "\$${selectedPlan!.price['monthly']?.toStringAsFixed(2)}/month",
//                         style: GoogleFonts.inter(
//                           fontSize: 12,
//                           color: AppColors.slateGray,
//                         ),
...
//                     : null,
//                 value: 'monthly',
//                 groupValue: selectedBillingCycle,
//                 onChanged: (value) {
//                   setState(() {
...
//             Expanded(
//               child: RadioListTile<String>(
//                 title: Text("Yearly", style: GoogleFonts.inter(fontSize: 13)),
//                 subtitle: selectedPlan != null
//                     ? Text(
//                         "\$${selectedPlan!.price['yearly']?.toStringAsFixed(2)}/year",
//                         style: GoogleFonts.inter(
//                           fontSize: 12,
//                           color: AppColors.slateGray,
//                         ),
...
//                   child: Padding(
//                     padding: const EdgeInsets.symmetric(horizontal: 12),
//                     child: Text("UPI", style: GoogleFonts.inter()),
//                   ),
//                 ),
//                 DropdownMenuItem(
//                   value: 'bank_transfer',
//                   child: Padding(
//                     padding: const EdgeInsets.symmetric(horizontal: 12),
//                     child: Text("Bank Transfer", style: GoogleFonts.inter()),
//                   ),
//                 ),
//                 DropdownMenuItem(
//                   value: 'cash',
//                   child: Padding(
//                     padding: const EdgeInsets.symmetric(horizontal: 12),
//                     child: Text("Cash", style: GoogleFonts.inter()),
//                   ),
//                 ),
//               ],
//               onChanged: (value) {
...
//         Expanded(
//           child: OutlinedButton(
//             onPressed: isAssigning ? null : () => Navigator.of(context).pop(),
//             child: Text(
//               "Cancel",
//               style: GoogleFonts.inter(color: AppColors.slateGray),
//             ),
